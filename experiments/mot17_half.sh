...
# Resulting model trained on MOT17 half train: https://s3.console.aws.amazon.com/s3/object/tri-ml-public?region=us-east-1&prefix=github/permatrack/mot_half.pth
